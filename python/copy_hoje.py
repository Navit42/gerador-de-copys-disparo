...
for j in range(count):
    with open("./copys/hoje.txt", "r", encoding='utf-8') as f:
        data = f.readlines()
    ...
    with open(os.path.join(path, "copy_hoje1.txt"), "w", encoding='utf-8') as f:
        for line in copy_1:
            f.write(line)
    
    with open(os.path.join(path, "copy_hoje2.txt"), "w", encoding='utf-8') as f:
        for line in copy_2:
            f.write(line)
    
    with open(os.path.join(path, "copy_hoje3.txt"), "w", encoding='utf-8') as f:
        for line in copy_3:
            f.write(line)
