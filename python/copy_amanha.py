...
for j in range(count):
    ...
    with open("./copys/amanha.txt", "r", encoding='utf-8') as f:
        data = f.readlines()
    ...
    with open(os.path.join(path, "copy_amanha1.txt"), "w", encoding='utf-8') as f:
        for line in copy_1:
            f.write(line)
    
    with open(os.path.join(path, "copy_amanha2.txt"), "w", encoding='utf-8') as f:
        for line in copy_2:
            f.write(line)
    
    with open(os.path.join(path, "copy_amanha3.txt"), "w", encoding='utf-8') as f:
        for line in copy_3:
            f.write(line)
